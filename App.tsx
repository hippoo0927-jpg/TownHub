      ...
      <div className="mt-auto p-6 border-t border-slate-900 bg-slate-900/30">
        <div className="flex flex-col gap-4">
          ...
          <a 
            ...
            className="w-full py-3 bg-red-600 text-white rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-red-700 transition-all shadow-lg shadow-red-900/20 active:scale-95"
          >
